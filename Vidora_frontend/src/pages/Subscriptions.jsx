...
const Subscriptions = () => {
    ...
    return (
        ...
        <h2 className="text-3xl font-bold mb-6 text-center">Your Subscriptions</h2>

        {loading ? (
            <div className="flex justify-center items-center h-60">
            <p className="text-xl text-gray-300 animate-pulse">Loading...</p>
            </div>
        ) : channels.length === 0 ? (
            <div className="flex justify-center items-center h-60">
            <p className="text-xl text-gray-400">You haven’t subscribed to any channels yet.</p>
            </div>
        ) : (
