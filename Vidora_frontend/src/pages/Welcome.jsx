...
const Welcome = () => {
    ...
    return (
        ...
        { !user.user ? 
            <div>
                <Navbar/>
                <div className="min-h-screen pt-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black px-6 py-10 flex flex-col md:flex-row-reverse flex-wrap items-center justify-center gap-6 overflow-hidden">
                ...
                <div className="text-center md:text-left max-w-2xl animate-fade-in-up">
                    ...
                    <br /> <span className="text-blue-300 font-medium">Watch. Upload. Connect.</span>
                    <br /> Your creative journey starts here.
                    <Link
                        to="/login"
                        className="bg-blue-600 text-white px-4 md:px-8 py-1 md:py-2 rounded-full hover:bg-blue-700 text-sm md:text-[20px] font-medium mx-5 shadow-xl hover:scale-105 hover:shadow-blue-500"
                        >
                        Login
                    </Link>
                    </p>
