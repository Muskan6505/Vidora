...
const SearchBar = ({ onChange }) => {
    ...
    return (
        <div className="w-full px-4 py-2 bg-gray-900 border-t-2 border-b-2 border-blue-700 shadow-md fixed top-15 z-50">
            <div className="max-w-5xl mx-auto flex flex-wrap items-center gap-3 md:gap-6">
                ...
                <div className="flex-grow min-w-[200px]">
                    <input
                        ...
                        className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700 bg-gray-700 text-white placeholder-gray-400"
                    />
                </div>
